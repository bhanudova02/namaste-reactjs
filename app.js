...
const restaurandData = [
    {
      ...
      "analytics": {
        "context": "seo-data-e654c437-a5ad-4f31-85d8-7d0b98755bd6"
      },
      "cta": {
...
const Header = () => {
  return (
    <header className="d-flex justify-content-between align-items-center px-4 py-3 shadow-sm position-fixed top-0 w-100 z-3 bg-white">
      <div className="d-flex align-items-center">
        <img src={Logo} width="100%" style={{ width: '40px' }} alt="img not render" />
        <div className="fw-semibold fs-5 text-success">BrandName</div>
      </div>
      <div>
        <ul className="list-unstyled d-flex gap-4 my-auto fw-medium">
          <li>Home</li>
          <li>AboutUs</li>
          <li>Contact Us</li>
          <li>Cart <span className="bi bi-cart3"></span></li>
        </ul>
      </div>
    </header>
  )
    ...
    <div>
        <div className="main-card p-2">
            <div className="card shadow-sm">
                  <img alt={"Logo"+"Food"} src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} width="100%" height="180" className="object-fit-cover card-img-top"/>
                  <div className="card-header border-0" style={{height:'100px'}}>
                    <h6 className="fw-bold">{name}</h6>
                    <h6>{cuisines.toString()}</h6>
                  </div> 
                  <div className="card-body pb-0">
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <h6 className="badge bg-success fs-6">{costForTwo}</h6>
                      <h6 className="badge bg-danger">{sla.deliveryTime} mins</h6>
                    </div>  
                  </div>     
             </div >
         </div> 
...
const Body = () => {
  return (
    <main className="px-4 py-3" style={{marginTop:'80px'}}>
      <div className="d-flex justify-content-center mb-5 mt-3 z-1">
...
const Footer = () =>{
  return(
    <footer className="bg-dark pt-3 pb-2 text-center fw-bold text-white">
      <div>© 2020 BranddName All rights reserved.</div>
    </footer>
  )
}
